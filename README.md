# Count votes on retro page extension
...
Click the Load unpacked button and navigate to the folder where your extension resides.

Add the folder. You will see a new plugin in the list.
